export const enDocs = {
  ...
  licensing: {
    ...
    adminItems: [
      "Licenses → Devices: see bound machines, unbind to free a slot, or bind a machine ID for support rebind.",
...
console.log(hb.state, hb.server_time);`,
  ...
  api: {
    ...
    adminRows: [
      ...
      ["POST", "/admin/v1/licenses/:key/activations", "Bind a device (support rebind)"],
